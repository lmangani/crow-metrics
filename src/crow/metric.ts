...
import { Distribution, MetricName, MetricType } from "./metric_name";
...
export class Metric {
  ...
  getValue(): number {
    if (this.value instanceof BiasedQuantileDistribution) throw new Error(`No single value for distributions.`);
